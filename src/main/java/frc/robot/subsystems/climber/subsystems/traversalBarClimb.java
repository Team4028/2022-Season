...
public class traversalBarClimb {
  ...
  public static traversalBarClimb get_instance() {
    traversalBarClimb _instance = new traversalBarClimb();
    return _instance;
  }
}
