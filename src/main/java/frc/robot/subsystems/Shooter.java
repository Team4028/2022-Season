...
public class Shooter extends SubsystemBase {
  ...
  public Shooter() {
    ...
    if (ShooterConstants.kIsBangBang) {
      _front.configPeakOutputForward(0.5);
      _back.configPeakOutputForward(0.8);
      _kicker.configPeakOutputForward(0.6);

      _front.configPeakOutputReverse(0.);
      _back.configPeakOutputReverse(0.);
      _kicker.configPeakOutputReverse(0.);
    }
