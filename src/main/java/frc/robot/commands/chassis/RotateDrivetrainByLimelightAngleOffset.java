...
public class RotateDrivetrainByLimelightAngleOffset extends ProfiledPIDCommand {
    /** Creates a new RotateDrivetrainByLimelightAngle. */
    private boolean continuous;

    public RotateDrivetrainByLimelightAngleOffset(DoubleSupplier offset, boolean continuous) {
        super(
                ...
                () -> Limelight.getInstance().getXForRot() * Math.PI / 180 + offset.getAsDouble(),
