...
public class FourBallAuton extends SequentialCommandGroup {
  ...
  public FourBallAuton() {
    ...
    addCommands(
      ...
      //new WaitCommand(0.2),
      _rc.getPathPlannerSwerveControllerCommand(Trajectories.FourBall_AcquireFirstCargo()).alongWith(new InstantCommand(() -> Infeed.getInstance().runInfeedSingulatorMotors(1.0))),
      new WaitCommand(0.5),
      ...
      _rc.getPathPlannerSwerveControllerCommand(Trajectories.FourBall_AcquireLoadingZoneCargo()).alongWith(new WaitCommand(0.5).andThen(new InstantCommand(() -> Shooter.getInstance().stop()))),
      new WaitCommand(1.5),
      _rc.getPathPlannerSwerveControllerCommand(Trajectories.FourBall_ReturnToShoot()).alongWith(new WaitCommand(0.5).andThen(new InstantCommand(() -> Shooter.getInstance().runShooterMotors()))),
      new WaitCommand(1.1).deadlineWith(new RunConveyor()),
