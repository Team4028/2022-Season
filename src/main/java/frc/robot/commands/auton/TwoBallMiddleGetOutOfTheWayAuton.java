...
public class TwoBallMiddleGetOutOfTheWayAuton extends BeakAutonCommand {
  /** Creates a new TwoBall_MiddleGetOutOfTheWay. */
  public TwoBallMiddleGetOutOfTheWayAuton() {
